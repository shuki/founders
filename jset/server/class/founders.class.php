...
/*
INSERT IGNORE INTO `attendance_item` (`parent`, `patient_id`, `creator`, `attend`, `comments`)
		select '13', parent, '1', coalesce(ae.attend,  1), coalesce(ae.comments, '')
		from attendant_plan ap
		inner join
		(
		SELECT parent, MAX(start_date) AS start_date
 ...
 * 
 * 
select parent, current_date() as `current_date`, start_date, 
